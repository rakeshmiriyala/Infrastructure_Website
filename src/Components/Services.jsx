...
const Services = () => {
  ...
  const images = [
    ...
    { src: image4, alt: 'Image 4', link: '/image4', title: 'Landscaping Works' },
  ];
    ...
    <div className="bg-black" id="services">
      ...
      <div className="flex lg:px-40 lg:mb-20 md:px-20 md:mb-15 sm:px-10 sm:mb-10 xs:px-8 xs:mb-8 rounded-lg shadow-md flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-1/2">
          <h3 className="lg:text-5xl md:text-4xl xs:text-4xl font-semibold text-white">Services We</h3>
          <h3 className="tlg:ext-5xl md:text-4xl xs:text-4xl font-semibold text-white"> Provide</h3>
        </div>

        {/* Right Part */}
        <div className="w-full sm:w-1/2 mt-5 sm:mt-0">
          <p className="lg:text-lg md:text-md text-white">
            There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even. The generated Lorem Ipsum is therefore always free from repetition, injected humour words.
          </p>
        </div>
      </div>
