...
import civilImg from "../../assets/waterproofing.jpg";
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row px-5 py-8">
              ...
              <li key={s.title} className="mb-2">
                <a
                  ...
                  className={`block px-4 py-4 ${
                    s.link === "/services/water-proofing-works"
        ...
        <div className="w-full md:w-3/4 md:pl-4 mt-6 md:mt-0">
          ...
          />
          {/* Service Title */}
          <h1 className="text-3xl font-bold mb-4">WaterProofing Works</h1>
          {/* Service Description */}
...
export default WaterProofingWorks;
