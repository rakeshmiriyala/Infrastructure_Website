          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <select
                  name="service"
                  className="w-full hover:cursor-pointer border-gray-400 focus:outline-none focus:border-[#00a69c] py-3 px-4 transition-all duration-300 border-b group-hover:border-[#00a69c]"
                  required
                >
                  ...
                  <option value="Fire Fitting Works">Fire Fitting Works</option>
