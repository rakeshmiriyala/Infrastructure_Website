  ...
  return (
    <footer className="bg-black text-white py-12 px-8 text-base">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-lg">
        ...
        <div>
          <p className="mb-2 lg:mt-12 sm:mt-0 text-lg">
            <a href="#" className="hover:text-gray-400">
              Fire Fitting Works
            </a>
          </p>
        ...
        <div>
          ...
          <p className="flex items-center mb-2 text-lg">
            <a
              href="https://www.facebook.com/ExelusIconicEngineering/"
              className="flex items-center hover:text-gray-400"
            >
              <FaFacebook className="mr-2 text-blue-600 text-xl sm:text-2xl" />{" "}
              Facebook
            </a>
          </p>
          <p className="flex items-center mb-2 text-lg">
            <a href="#" className="flex items-center hover:text-gray-400">
              <FaTwitter className="mr-2 text-blue-400 text-xl sm:text-2xl" />{" "}
              Twitter
            </a>
          </p>
          <p className="flex items-center mb-2 text-lg">
            <a
              href="https://www.instagram.com/exelus_iconic_engineering/"
              className="flex items-center hover:text-gray-400"
            >
              <FaInstagram className="mr-2 text-pink-500 text-xl sm:text-2xl" />{" "}
              Instagram
            </a>
          </p>
          <p className="flex items-center text-lg">
            <a
              href="https://youtube.com/@exelusiconicandengineering?si=nLrBOaXa8qTGwYPG"
              className="flex items-center hover:text-gray-400"
            >
              <FaYoutube className="mr-2 text-red-600 text-xl sm:text-2xl" />{" "}
              YouTube
            </a>
          </p>
        </div>
